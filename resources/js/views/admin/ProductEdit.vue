<template>
    <div class="row">
        ...
        <div class="col s12">
            <div class="row">
                <div class="col s12">
                    <h5 style="margin-top: 0px;">Редагувати продукт</h5>
        ...
        <div class="col s12"  v-if="product.id">
...
<script defer="defer">
    ...
    //            $.each(this.attributes_selected, function (i, v) {
        ...
        methods: {
            ...
            onSubmit($event) {
                ...
                axios.put('/api/product', this.product).then((response) => {
                    M.toast({html: 'Продукт відредагован'});
                    this.loaded = true;
                })
                .catch((error) => {
                    this.loaded = true;
